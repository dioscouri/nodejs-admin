...
class SecuredController extends BaseController {
    ...
    getPermissionsForProtectedActions(userId, asyncCallback) {
        ...
        async.forEach(this.protectedActions, function (actionName, foreachCallback) {
            DioscouriCore.ApplicationFacade.instance.server.acl.isAllowed(userId.toString(), this.aclResourceName.toLowerCase(), actionName.toLowerCase(), function (err, allowed) {
        ...
        async.series([
            function (asyncCallback) {
                if (!isProtectedResource) {
                    ...
                    DioscouriCore.ApplicationFacade.instance.server.acl.isAllowed(that.request.user._id.toString(), this.aclResourceName.toLowerCase(), $actionName.toLowerCase(), function (err, allowed) {
 ...
 * @type {Function}
 */
exports = module.exports = SecuredController;